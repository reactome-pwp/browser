...
public class SizeFiltering extends FlowPanel implements FilteringWidget,
    ...
    private void updateHistogram() {
        ...
        AnalysisClient.getPathwaysBinnedBySize(result.getSummary().getToken(), filter.getResource(), binSize, filter.getpValue() != null ? filter.getpValue() : 1d, filter.getSpeciesString(), new AnalysisHandler.PathwaysBinned() {
            @Override
